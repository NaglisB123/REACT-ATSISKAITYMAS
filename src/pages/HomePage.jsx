...
export default function HomePage() {
  return (
    <div className="bg text-2xl px-20 text-zinc-50 translate-x-30">
      <p className="pt-20">
        NEW COLLECTION IN THE STYLE OF OLD <strong className="italic">BIRMINGHAM</strong>
      </p>
      <h1 className="text-8xl pt-10 pb-20">Beautifully Crafted <strong className="italic">Vintage</strong> Furniture</h1>
