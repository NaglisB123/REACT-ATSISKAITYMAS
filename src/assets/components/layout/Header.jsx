  ...
  return (
    <header className="bg-rose-700 py-11">
      <nav className="flex space-x-4 justify-center">
        <Toaster />
        <div className="flex justify-between items-center w-screen px-20">
          <div className="flex items-center">
            <img className="h-16" src="./public/logo.jpg" alt="company logo" />
            <Link
              to="/home-page"
          ...
          <ul className="flex space-x-4">
            <li>
              {!ctx.isLoggedIn && (
                <NavLink
                  to="/register-page"
                  className="text-3xl text-white hover:text-gray-200 px-10"
                >
                  Register
                </NavLink>
              )}
            ...
            <li>
              {ctx.isLoggedIn && (
                <Link
                  className="text-3xl text-white hover:text-gray-200 cursor-pointer px-10"
                  to="/addpage"
                >
                  Ad page
                </Link>
